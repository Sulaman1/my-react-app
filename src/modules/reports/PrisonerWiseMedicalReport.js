...
const PrisonerWiseMedicalReport = () => {
  ...
  return (
    <BaseReportComponent
      reportName="Prisoner Wise Medical"
      ...
      excelFileName="prisoner_wise_medical_report"
    />
  );
};

export default PrisonerWiseMedicalReport;
