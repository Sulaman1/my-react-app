...
import imgtwo from '../../../assets/images/users/1.png';
...
const EmployeeListNew = props => {


    return (
        
            <><><h2>Mateen Employee List</h2>
        </>
        <React.Fragment>
        <div class="card">
                            <div class="card-body">
                                <div class="row g-2">
                                    ...
                                    <div class="col-sm-auto ms-auto">
                                        ...
                                        <button type="button" id="grid-view-button" class="btn btn-soft-info nav-link btn-icon fs-14 active filter-button"><i class="ri-grid-fill"><BiTable size ="1.5em"/>
                                                </i></button>
                                            <button type="button" id="list-view-button" class="btn btn-soft-info nav-link  btn-icon fs-14 filter-button"><i class="ri-list-unordered"><AiOutlineUnorderedList size="1.5em"/></i></button>
                                                        ...
                                                        <div class="col team-settings">
                                                            <div class="row">
                                                                ...
                                                                <div class="col text-end dropdown">
                                                                    <a href="javascript:void(0);" id="dropdownMenuLink2" data-bs-toggle="dropdown" aria-expanded="flase">
                                                        ...
                                                        <div class="col-lg-4 col">
                                                            <div class="team-profile-img">
                                                                <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0">
                                                                    <img src={imgtwo} alt="" class="img-fluid d-block rounded-circle" />
                                                                </div>
                                                                <div class="team-content">
                                                                    <a data-bs-toggle="offcanvas" href="#offcanvasExample" aria-controls="offcanvasExample"><h5 class="fs-16 mb-1">Abdullah tariq</h5></a>
                                    ...
                                    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="offcanvasExample">
                                        ...
                                        <div class="offcanvas-body profile-offcanvas p-0">
                                            ...
                                            <div class="p-3 text-center">
                                                <img src="PMIS_Balochistan_Template/assets/images/users/1.jpg" alt="" class="avatar-lg img-thumbnail rounded-circle mx-auto"/>
                                                <div class="mt-3">
