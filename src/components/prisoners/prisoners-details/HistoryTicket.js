...
const HistoryTicket = () => {
  ...
  const handlePrint = () => {
	  ...
	  window.location.href = "/admin/prisoner-search";
  	// history.goBack()
  }
  return (
    <>
          ...
          <div class="row">
            <div class="table-main">
              <div class="hover-card">
                <h4 class="third-heading heading">Personal Information</h4>
                  ...
                  <div class="d-flex just-space mx-n3">
                    <ul class="list col-xl-12 list-group list-group-flush colm-2-tabel mb-0">
                      ...
                      <li class="list-group-item">
                        <div class="d-flex align-items-center pagi-list">
                          <div class="flex-grow-1 overflow-hidden">
                            <h5 class="fs-13 mb-1 dynamic-key">DOB: </h5>
                          </div>
                          <div class="flex-shrink-0 ms-2">
                            <div>
                              <p class="dynamic-value">
                      ...
                      <li class="list-group-item">
                        <div class="d-flex align-items-center pagi-list">
                          ...
                          <div class="flex-shrink-0 ms-2">
                            <div>
                              <p class="dynamic-value">
                                {userData?.highProfile ? "Yes" : "No" || "N/A"}
                              </p>
                            </div>
                          </div>
                        </div>
					...
					<WarrantsTable prisonerCases={userData?.prisonerCase || []} />
      </div>
	  </div>
    </>
  );
